      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4 text-foreground/80">
            <Heading level={3}>Join Our Journey</Heading>
            <Text>
              We don&apos;t have any open staff positions or formal internship
              slots right now, but we are always looking for passionate minds.
              If you&apos;re deeply committed to marine conservation, community
            ...
            <Text>
              ...
              We&apos;ll keep your details on hand and reach out the moment a
              spot opens up.
            </Text>
          </div>
          <a
