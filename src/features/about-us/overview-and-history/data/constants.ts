export const OVERVIEW_TEXT = `Guiuan Development Foundation, Inc. (GDFI) is a nonstock, non-profit, non-governmental organization committed to empowering coastal communities, protecting the environment, and conserving natural resources. We operate in 7 coastal municipalities in Eastern Samar, from Guiuan to Lawaan.`
...
export const HISTORY_MILESTONES: HistoryMilestone[] = [
  ...
  },
  {
    ...
    description:
      'Resilience requires constant adaptation. Following the devastation of Super Typhoon Haiyan, GDFI critically re-evaluated its vision and mission to address modern climate realities.\n\nThe foundation adopted a holistic "Ridge to Reef" approach for all succeeding programs, explicitly incorporating Disaster Risk Reduction and Climate Change Adaptation (DRR-CCA) to ensure that both the coastal ecosystems and the communities that rely on them can withstand future environmental challenges.',
  },
]
