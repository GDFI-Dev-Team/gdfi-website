export const OVERVIEW_TEXT = `During the 1980s, the coastal municipalities of southern Samar Island faced a severe ecological crisis. Rampant illegal practices, including dynamite and cyanide fishing, were rapidly depleting marine resources and threatening the livelihoods of the 40,000 residents who heavily depended on the sea. Driven by a deep concern for these vulnerable fishing communities, Prof. Margarita de la Torre - de la Cruz, then a faculty member at the University of the Philippines Visayas Tacloban College (UPVTC), took decisive action to organize a response.
